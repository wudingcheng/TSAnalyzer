...
from qtpy.QtCore import Signal, QDate
...
class TSOffsetDialog(QDialog, OffsetDialog):
    JUMP_EDITOR_DONE = Signal(dict)
    JUMP_EDITOR_DELETE = Signal(dict)
    ...
    def __init__(self, parent=None, breaks='eq', col='north', date='20000102', tau=0):
        ...
        self.offsetBox.currentIndexChanged.connect(
            lambda i: self.eqGroup.setVisible(i))
